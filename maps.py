...
class MapParams(object):
    def __init__(self):
        self.lat = 55.790707  # Координаты центра карты на старте. Наша школа
        self.lon = 37.796510
        self.zoom = 18  # Масштаб карты на старте. Изменяется от 1 до 19
...
def main():
    ...
    while True:
        ...
        karta = pygame.image.load(map_file)
        scale = pygame.transform.scale(karta, (650, 450))
